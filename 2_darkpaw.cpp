...
void *Camera(void *arg)
{
    ...
    params.psr_threshold = 0.1f; /* Deafault value= 0.035 CSRT Tracker parameter to make it more sensible to false positives */
	...
	while (detection)
	{
	  ...
	  after = clock();
	  if (fabs(contourArea(contours[contours_chosen]))>500 && (((double)(after-before)/(double)CLOCKS_PER_SEC)>10 ))
	    {
