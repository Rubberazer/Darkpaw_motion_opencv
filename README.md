...
11/03/2021: Added an OpenCV MOG2 background substractor and a tracker, currently using a CSRT, the background substractor detects movement and focuses on the biggest area to pass that rectangle to the tracker so it gets initialized, it works. FPS are rubbish but still is able to follow slow motion objects.
