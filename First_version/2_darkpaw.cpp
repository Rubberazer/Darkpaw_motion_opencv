...
void *Camera(void *arg)
{
    ...
    vector<int> params_stream;
    params_stream.push_back(IMWRITE_JPEG_QUALITY);
    params_stream.push_back(90); /* JPEG quality (1...100) */
	...
	while (detection)
	{
	  ...
	  imencode(".jpg", frame, outbuf, params_stream);
